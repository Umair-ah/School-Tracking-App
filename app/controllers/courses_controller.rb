class CoursesController < ApplicationController
  ...
  def generate_lessons
    # delete future lessons to regenrate them(deletes prevous lessons if you decided to change timings)
  ...
  private
    ...
    def course_params
      params.require(:course).permit(:user_id, :classroom_id, :service_id, :start_time, *Course::DAYS_OF_WEEK, enrollments_attributes: [:id, :user_id, :_destroy])
    end
end
