...
Service.create(name: "Math", duration: 30, client_price: 0 )
Service.create(name: "Massage", duration: 40, client_price: 100 )
Service.create(name: "Yoga", duration: 50, client_price: 200 )
